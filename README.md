...
```bash
git clone git@github.com:raheelsoft/agent-skills.git ~/.claude/skills/app-pipeline-setup
```

Claude Code picks up any skill under `~/.claude/skills/<name>/` automatically — `SKILL.md`'s frontmatter is what makes it discoverable.
